...
/**
 * @class test system core module
 * @lends MeinAutoJs.test.core.SystemTest
 */
MeinAutoJs.define('MeinAutoJs.test.core.SystemTest', new function () {
    /**
     * @description test has pre setted type string
     * @memberOf MeinAutoJs.test.core.SystemTest
     * @param {MeinAutoJs.test.Unit.assert} assert
     * @param {MeinAutoJs.core.System} moduleClass
     */
    ...
    this.testGetNamespace = function (assert, moduleClass) {
        assert.ok(
            ('core/System' === moduleClass.getNamespace(moduleClass.type)),
            'get namespace is "core/System"'
        );
    };
    ...
    this.testDefineModuleClassWithCorrectParameterTypeButNoClassObject = function (assert, moduleClass) {
        ...
        moduleClass.construct(true, function () {
            assert.throws(
                function() {
                    MeinAutoJs.define('MeinAutoJs.mock.ModuleClassNamespace');
                },
            ...
            assert.throws(
                function() {
                    MeinAutoJs.define('MeinAutoJs.mock.ModuleClassNamespace', 1);
                },
                new Error('The module class must be of type <Object>.'),
    ...
    this.testDefineModuleClassWithCorrectParameterTypeAndClassObject = function (assert, moduleClass) {
        ...
        moduleClass.construct(true, function () {
            MeinAutoJs.define('MeinAutoJs.mock.ModuleClassNamespace', new function () {});

            var MockModuleClassNamespace = MeinAutoJs.mock.ModuleClassNamespace;
    ...
    this.teardown = function () {
        removeModuleDOM('MeinAutoJs.mock.ModuleClassNamespace');
    };
